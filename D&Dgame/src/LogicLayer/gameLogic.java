      ...
      for(int i=0 ; i<width ; i++) {
    	  for(int j=0 ; j<length ; j++) {
    		  ...
    		  swicth(c){
    			  ...
    			  case 's': GO =  new Monster(i,j,"Lannister Soldier", 80, 3, 8, 25, c, 3);
    			  case 'k': GO =  new Monster(i,j,"Lannister Knight", 200, 8, 14, 50, c, 4);
    			  case 'q': GO =  new Monster(i,j,"Queen's Guard",400, 15, 20,100, c, 5);
    			  case 'z': GO =  new Monster(i,j, "Wright", 600, 15, 30, 100, c, 3);
    			  case 'b': GO =  new Monster(i,j, "Bear Wright", 1000, 30, 75, 250, c, 4);
    			  case 'g': GO =  new Monster(i,j, "Giant Wright", 1500, 40, 100, 500, c, 5);
    			  case 'w': GO =  new Monster(i,j," White Walker", 2000, 50, 150, 1000, c, 6);
    			  case 'M': GO =  new Monster(i,j,"The Mountain", 1000, 25, 60, 500, c, 6);
    		  ...
    		  output[i][j] = GO;
    		  if(GO.isEnemy()) {} //add to enemy list
    	  }
      }
	   //need to implement!!!!
      return null;
